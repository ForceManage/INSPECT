...
public class CertificateInspectionAttributes {
    ...
    public CertificateInspectionAttributes(int inspectionId, int projectId, int aId, String date, String overview, String servicedBy, String relevantInfo, String serviceLevel, String reportImage, String image1
