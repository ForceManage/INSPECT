...
public class DocPageViewFragment extends Fragment implements OnDocChangeListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.report_body_fragment, container, false);
        ...
        photoA = (ImageView) view.findViewById(R.id.imageView1);
